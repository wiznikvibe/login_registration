...
class Login_window:
    def __init__(self, root):
        ...
        log_in = Label(frame, text="Login", font=('Arial',11,'bold'),bg='white')
        log_in.place(x=73,y=35)
        user_lab = Label(frame, text="Username:", font=('Arial',8,'normal'),bg='white')
        user_lab.place(x=10, y=75)
        pass_lab = Label(frame, text="Password:", font=('Arial',8,'normal'),bg='white')
        pass_lab.place(x=10, y=95)
        user_entry = Entry(frame, font=('Arial',8,'normal'),bg='white')
        user_entry.place(x=70,y=75, width=95)
